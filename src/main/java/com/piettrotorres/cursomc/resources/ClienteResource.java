...
import com.piettrotorres.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<?> findByEmail(@RequestParam(name="value") String email) {
